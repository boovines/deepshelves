...
CREATE TABLE 'frame_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;

CREATE TABLE 'frame_fts_data'(id INTEGER PRIMARY KEY, block BLOB);

CREATE TABLE 'frame_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);

CREATE TABLE 'frame_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWID;
