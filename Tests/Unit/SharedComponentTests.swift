...
final class SharedComponentTests: XCTestCase {
    ...
    func testSearchFieldAndProgressBehaviorMatchUXSpecification() {
        ...
        XCTAssertFalse(ProgressStatusModel(label: "Searching", elapsedSeconds: 0.300).showsIndicator)
    ...
    func testCaptureStatusNeverDependsOnColorAlone() {
        ...
        XCTAssertEqual(Set(CaptureStatusState.allCases.map { $0.presentation.systemImage }).count, 4)
    }
